...
const COMMANDS: Record<string, () => OutputLine[]> = {
  ...
  '--impact': () => [
    { text: '> Systems Re-Engineered & Ventures:', type: 'success' },
    { text: '  [1] 0 Hexagon Studio: Live Social Deduction Entertainment Platform', type: 'output' },
    { text: '      Founder & Full-Stack Systems Builder (Next.js, Supabase, Admin Dashboard)', type: 'output' },
    { text: '  [2] Al-Safir (السفير): Hajj & Umrah Agency B2B SaaS Platform', type: 'output' },
    { text: '  [3] Al-Khabir AI: Voice-activated agri-intelligence for farmers', type: 'output' },
    { text: '      🏆 Award: Territorial Impact & Public Utility (Ramadan IA)', type: 'output' },
    { text: '  [4] Atlas Source: Global E-Commerce & SEO Strategy', type: 'output' },
    { text: '  [5] Strategic Talent Positioning for sports professionals', type: 'output' },
  ],
  '--shaper': () => [
...
const WELCOME_LINES: OutputLine[] = [
  ...
  { text: '║         Moussab Fatmi | مصعب فاطمي v2.0           ║', type: 'success' },
  { text: '╚══════════════════════════════════════╝', type: 'success' },
              ...
              >
                ...
                >
                  {lines.map((line, i) => (
                    <div
                      key={i}
                      className={`leading-relaxed whitespace-pre-wrap ${line.type === 'error' ? 'text-red-400' :
