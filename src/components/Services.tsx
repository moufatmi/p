      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            ...
            >
              <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-sky-400 to-sky-600 rounded-2xl mb-6 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="mt-16 bg-gradient-to-r from-sky-500 to-orange-500 rounded-3xl p-8 md:p-12 text-center text-white">
          ...
          <button className="bg-white text-sky-600 px-8 py-3 rounded-full text-lg font-semibold hover:bg-gray-100 transition-colors duration-200">
